...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_ansi_84(
     KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,    KC_VC_HAND,  MO_FN,    KC_VC_MUTE,
     ...
     KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_GREEK, KC_CADET, KC_YIDDISH, KC_LEFT,     KC_DOWN,  KC_RGHT),
